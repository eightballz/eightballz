## Who am I?
👋 My name is Liam, or Eightballz, which is my alias. I'm a student from the United States, and I enjoy creating a variety of projects in my free time!

## What I  can do:
- 🟢 Minecraft Servers, Web Design
- 🟡 Kotlin, Java, JavaScript, TypeScript, NodeJS
- 🔴 React, GoDot/GDScript

🟢 Adequate  🟡 Intermediate  🔴 Learning

## Past Projects:
- 🗺️ Origin Zero: A geopolitical Minecraft Server where each player creates and manages their own nation.
...
- 🎵 Songs: Let it Happen (Tame Impala), Pork Soda (Glass Animals), Rhythm Inside (Loïc Nottet), Hey Now (Kendrick Lamar), Not My World (Tame Impala), Bleed the Freak (Alice in Chains)  
